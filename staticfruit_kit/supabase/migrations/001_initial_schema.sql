...
-- Create storage bucket for graphs (run this in Supabase dashboard)
-- Note: This needs to be created via the Supabase dashboard or API
-- Bucket name: staticfruit-graphs
-- Public access: true
