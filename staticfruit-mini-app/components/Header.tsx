...
export default function Header(){
  return (<div className='flex items-center justify-between mb-4'>
    <div className='flex items-center gap-3'>
      ...
      <div><div className='text-lg font-bold font-orbitron text-white'>StaticFruit</div><div className='text-xs text-silver font-inter'>Horoscope • Bars • Markets</div></div>
    </div>
    <BaseAuthButton />
  </div>);
}